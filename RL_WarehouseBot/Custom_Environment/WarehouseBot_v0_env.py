...
sys.path.insert(1, 'RL_WarehouseBot/Custom_Environment')
# Register this module as a gym environment. Once registered, the id is usable in gym.make().
register(
    # call it whatever you want
    id='WarehouseBot-v0',
    entry_point='WarehouseBot_v0_env:WarehouseRobotEnv',  # module_name:class_name
)
...
if __name__ == "__main__":
    env = gym.make('WarehouseBot', render_mode='human')
